...
public class Main {
	...
	protected static int N_TRIANGLES_MUTATION =1;
	//protected static boolean ALLOW_REPEATED = false;
	public static boolean ELITISM = true;
	public static boolean FITNESS_SHARING = true;
	public static double  AVG_GENOTYPIC_DIST_MIN_VALUE=130;
	...
	public static void main(String[] args) {		
		...
		System.out.println("MUTATION_PROBABILITY is " + MUTATION_PROBABILITY +" AND MUTATING " + N_TRIANGLES_MUTATION +" TRIANGLES" );
		...
		System.out.println("ELITISM is " + ELITISM);
		System.out.println("FITNESS_SHARING is " + FITNESS_SHARING);
		System.out.println("AVG_GENOTYPIC_DIST_MIN_VALUE is " + AVG_GENOTYPIC_DIST_MIN_VALUE);
