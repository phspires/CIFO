...
public class Main {
	...
	public static final int NUMBER_OF_GENERATIONS = 50000; 
	public static final int POPULATION_SIZE = 25;
	public static final double MUTATION_PROBABILIY = 0.5; 
	public static final int TOURNAMENT_SIZE = 3; 
	
	public static final boolean SMOTHER_MUTATIONS = false;
	public static final boolean BEST_PARENTS = false;
	public static final boolean CROSSOVER_TWOPOINTS = true;
