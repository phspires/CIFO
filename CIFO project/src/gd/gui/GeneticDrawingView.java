...
import cifo.GeneticAlgorithm;
import cifo.ProblemInstance;
import cifo.SearchMethod;
...
public class GeneticDrawingView extends FrameView {
	...
	public void startEvolution() throws InvalidConfigurationException {
		...
		if (isEvolutionActivated == false) {
			...
			SearchMethod searchMethod = new GeneticAlgorithm();
	...
	private void initComponents() {
		...
		javax.swing.ActionMap actionMap = org.jdesktop.application.Application
				.getInstance(gd.gui.GeneticDrawingApp.class).getContext().getActionMap(GeneticDrawingView.class, this);
		...
		chartPanelLayout.setVerticalGroup(chartPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
